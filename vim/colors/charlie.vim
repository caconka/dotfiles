...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" PHP Highlighting
	call <SID>X("phpVarSelector", s:green, "", "")
	...
	call <SID>X("htmlScriptTag", s:foreground, "", "")
    ...
    call <SID>X("cssFunctionName", s:yellow, "", "")
    call <SID>X("cssBraces", s:foreground, "", "")

    call <SID>X("cssTextProp", s:blue, "", "")
    call <SID>X("cssAnimationProp", s:blue, "", "")
    call <SID>X("cssUIProp", s:yellow, "", "")
	call <SID>X("cssTransformProp", s:blue, "", "")
	call <SID>X("cssTransitionProp", s:blue, "", "")
	call <SID>X("cssPrintProp", s:blue, "", "")
    call <SID>X("cssPositioningProp", s:yellow, "", "")
    call <SID>X("cssBoxProp", s:blue, "", "")
    call <SID>X("cssFontDescriptorProp", s:blue, "", "")
    call <SID>X("cssFlexibleBoxProp", s:blue, "", "")
	call <SID>X("cssBorderOutlineProp", s:blue, "", "")
	call <SID>X("cssBackgroundProp", s:blue, "", "")
	call <SID>X("cssMarginProp", s:blue, "", "")
    call <SID>X("cssListProp", s:blue, "", "")
    call <SID>X("cssTableProp", s:blue, "", "")
    call <SID>X("cssfontProp", s:blue, "", "")
    call <SID>X("cssPaddingProp", s:blue, "", "")
	call <SID>X("cssDimensionProp", s:blue, "", "")
	call <SID>X("cssRenderProp", s:blue, "", "")
	call <SID>X("cssColorProp", s:blue, "", "")
    call <SID>X("cssGeneratedContentProp", s:blue, "", "")    
  ...
  let s:diffbackground = "494e56"
	...
	call <SID>X("diffAdded", s:yellow, "", "")
	call <SID>X("diffRemoved", s:red, "", "")
  call <SID>X("DiffAdd", s:yellow, s:diffbackground, "")
