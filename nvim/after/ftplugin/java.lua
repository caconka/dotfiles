...
local config = {
	...
	root_dir = require("jdtls.setup").find_root({ ".git", "mvnw", "pom.xml", "build.gradle", "gradlew", "WORKSPACE", "BUILD", "BUILD.bazel" }),
...
-- Disable JDTLS for monorepo projects
if not string.match(vim.fn.getcwd(), ".*monorepo.*") then
